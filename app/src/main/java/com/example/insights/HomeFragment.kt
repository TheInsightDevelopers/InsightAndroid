...
import com.example.insights.BookRecylerViewAdapter2
                ...
                if (value != null) {
                    for (change in value.documentChanges) {
                        if (change.type == DocumentChange.Type.ADDED) {
                            ...
                            val BookRecylerViewAdapter = BookRecylerViewAdapter2(this, videoValues)
                            recyclerView2.adapter = BookRecylerViewAdapter
                        }
                    }
                }
            }
