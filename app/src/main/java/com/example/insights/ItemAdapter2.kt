...
class BookRecylerViewAdapter2(val context: HomeFragment, val items :ArrayList<HashMap<String,String>>): RecyclerView.Adapter<BookRecylerViewAdapter2.ViewHolder>() {
    lateinit var Url: String
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BookRecylerViewAdapter2.ViewHolder {
        return ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_custom_row_home_video,parent,false))
    }

    override fun onBindViewHolder(holder: BookRecylerViewAdapter2.ViewHolder, position: Int) {
